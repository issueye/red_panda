...
export function normalizeRunMessageStream(stream) {
  return {
    ...
    workerSeq: stream.worker_seq || 0,
    endWorkerSeq: stream.end_worker_seq || stream.worker_seq || 0,
    streamId: stream.stream_id || '',
    streamKind: stream.stream_kind || '',
    streamSeq: stream.stream_seq || 0,
    endStreamSeq: stream.end_stream_seq || stream.stream_seq || 0,
    streamFinal: Boolean(stream.stream_final),
