...
- MCP process reuse, discovery cache, crash/restart budget, and protocol-level cancellation are implemented. Remaining product gap: Desktop "try-call" UI for discovered tools.
